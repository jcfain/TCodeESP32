...
public:
    ...
    void getMovement(char *buf, size_t len)
    {
        ...
        buf[0] = {0};
        // LogHandler::verbose(Tags::Motion, "getMovement Enter");
    ...
    void setMotionChannels(const std::vector<MotionChannel> &motionChannels)
    {
        ...
        {
            LogHandler::debug(Tags::Motion, "Setup motion channel: %s", motionChannels[i].name);
    ...
    void setEnabled(bool enable, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setEnabled: %ld", enable);
        xSemaphoreGive(xMutex);
    }
    ...
    void setUpdate(int value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setUpdate: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void setPeriod(int value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setPeriod: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void setPeriodRandom(bool value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setPeriodRandom: enabled %ld", value);
        xSemaphoreGive(xMutex);
    }
    void setPeriodRandomMin(int min, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setPeriodRandomMin: %ld", min);
        xSemaphoreGive(xMutex);
    }
    void setPeriodRandomMax(int max, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setPeriodRandomMax: %ld", max);
        xSemaphoreGive(xMutex);
    }
    ...
    void setOffset(int value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setOffset: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void setOffsetRandom(bool value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setOffsetRandom: enabled %ld", value);
        xSemaphoreGive(xMutex);
    }
    void setOffsetRandomMin(int min, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setOffsetRandomMin: %ld", min);
        xSemaphoreGive(xMutex);
    }
    void setOffsetRandomMax(int max, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setOffsetRandomMax: %ld", max);
        xSemaphoreGive(xMutex);
    }
    ...
    void setAmplitude(int value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setAmplitude: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void setAmplitudeRandom(bool value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setAmplitudeRandom: enabled %ld", value);
        xSemaphoreGive(xMutex);
    }
    void setAmplitudeRandomMin(int min, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setAmplitudeRandomMin: %ld", min);
        xSemaphoreGive(xMutex);
    }
    void setAmplitudeRandomMax(int max, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setAmplitudeRandomMax: %ld", max);
        xSemaphoreGive(xMutex);
    }
    ...
    void setMotionRandomChangeMin(int min, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setMotionRandomChangeMin: %ld", min);
        xSemaphoreGive(xMutex);
    }
    ...
    void setMotionRandomChangeMax(int max, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setMotionRandomChangeMax: %ld", max);
        xSemaphoreGive(xMutex);
    }
    ...
    void setPhase(int value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setPhase: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void setReverse(bool value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "setReverse: %ld", value);
        xSemaphoreGive(xMutex);
    };
    ...
    void stopAtCycle(float value, const char *name = 0)
    {
        ...
        LogHandler::debug(Tags::Motion, "stopAtCycle: %f", value);
        xSemaphoreGive(xMutex);
    };
