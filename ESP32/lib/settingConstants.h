...
#define BLDC_TWIST_PULLEY_CIRCUMFERENCE_DEFAULT 60
#define BLDC_TWIST_MOTOR_VOLTAGE_DEFAULT 20.0f
#define BLDC_TWIST_MOTOR_SUPPLY_DEFAULT 20.0f
#define BLDC_TWIST_MOTOR_CURRENT_DEFAULT 1.0f
#define BLDC_TWIST_MOTOR_PARAMETERSKNOWN_DEFAULT false
#define BLDC_TWIST_MOTOR_ZEROELECANGLE_DEFAULT -12345.0f // FOC NOT_SET
#define BLDC_TWIST_RAILLENGTH_DEFAULT 125
#define BLDC_TWIST_LENGTH_DEFAULT 120
...
#define BLDC_TWIST_MOTOR_CURRENT "BLDC_TwistMotor_Current"
#define BLDC_TWIST_MOTOR_PARAMETERSKNOWN "BLDC_TwistMotor_ParametersKnown"
#define BLDC_TWIST_MOTOR_ZEROELECANGLE "BLDC_TwistMotor_ZeroElecAngle"
#define BLDC_TWIST_RAILLENGTH "BLDC_TwistRailLength"
#define BLDC_TWIST_LENGTH "BLDC_TwistLength"
