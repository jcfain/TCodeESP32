...
#define BLDC_ENABLE_PIN_DEFAULT 4
#define BLDC_HALLEFFECT_PIN_DEFAULT 6
#define BLDC_PWMCHANNEL1_PIN_DEFAULT 3
#define BLDC_PWMCHANNEL2_PIN_DEFAULT 2
#define BLDC_PWMCHANNEL3_PIN_DEFAULT 1

// TWIST BLDC (SSR2)
#define BLDC_TWIST_ENCODER_PIN_DEFAULT 11
#define BLDC_TWIST_CHIPSELECT_PIN_DEFAULT 12
#define BLDC_TWIST_ENABLE_PIN_DEFAULT 13
#define BLDC_TWIST_HALLEFFECT_PIN_DEFAULT -1
#define BLDC_TWIST_PWMCHANNEL1_PIN_DEFAULT 14
#define BLDC_TWIST_PWMCHANNEL2_PIN_DEFAULT 16
#define BLDC_TWIST_PWMCHANNEL3_PIN_DEFAULT 17