...
const Channel ChannelMapV3[14] = {
    ...
    {"R1","Roll",0,500,999,false,false},
    {"R2","Pitch",0,500,999,false,false},
    {"V0","Vibe 1",0,500,999,true,false},
    {"V1","Vibe 2",0,500,999,true,false},
    {"V2","Vibe 3",0,500,999,true,false},
    {"V3","Vibe 4",0,500,999,true,false},
    {"A0","Suck manual",0,500,999,false,false},
    {"A1","Suck level",0,500,999,false,false},
    {"A2","Lube",0,500,999,true,false},
    {"A3","Squeeze",0,500,999,false,false}
};

const Channel ChannelMapBLDC[8] = {
    {"L0","Stroke",0,500,999,false,false},
    {"V0","Vibe 1",0,500,999,true,false},
    {"V1","Vibe 2",0,500,999,true,false},
    {"V2","Vibe 3",0,500,999,true,false},
