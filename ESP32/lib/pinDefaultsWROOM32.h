...
#define RIGHT_SERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH0_CH0
#define LEFT_SERVO_PIN_DEFAULT 15
#define LEFT_SERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH0_CH1
#define PITCH_LEFT_SERVO_PIN_DEFAULT 4
#define PITCH_LEFT_SERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH1_CH2

// SR6
#define RIGHT_UPPER_SERVO_PIN_DEFAULT 12
#define RIGHT_UPPER_SERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH2_CH4
#define LEFT_UPPER_SERVO_PIN_DEFAULT 2
#define LEFT_UPPER_SERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH2_CH5
#define PITCH_RIGHTSERVO_PIN_DEFAULT 14
#define PITCH_RIGHTSERVO_CHANNEL_DEFAULT (int8_t)ESPTimerChannel::HIGH1_CH3
