...
// TWIST BLDC (SSR2)
#define BLDC_LEFT_ENCODER_PIN_DEFAULT 34
#define BLDC_LEFT_CHIPSELECT_PIN_DEFAULT 5
#define BLDC_LEFT_ENABLE_PIN_DEFAULT 26
#define BLDC_LEFT_HALLEFFECT_PIN_DEFAULT -1
#define BLDC_LEFT_PWMCHANNEL1_PIN_DEFAULT 25
#define BLDC_LEFT_PWMCHANNEL2_PIN_DEFAULT 33
#define BLDC_LEFT_PWMCHANNEL3_PIN_DEFAULT 32